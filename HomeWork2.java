...
class HomeWork2 {
    public static void main(String[] args) {
        ...
        String[][] arr1 = {{"10", "20", "30", "40"}, {"100", "200", "300", "400"}, {"1000", "2000", "3000", "4000"}, {"10000", "20000", "30000", "40000"}};
        String[][] arr2 = {{"10", "20", "30", "40"}, {"100", "200", "300", "400"}, {"1000", "2000", "4000"}, {"10000", "20000", "30000", "40000"}};
        String[][] arr3 = {{"10", "20", "30", "40"}, {"100", "200", "300", "400"}, {"1000", "2000", "3000", "4000"}, {"10000", "20000", "30000", "40000"}, {"1", "2", "3", "4"}};
        String[][] arr4 = {{"10", "20", "thirty", "40"}, {"100", "200", "300", "400"}, {"1000", "2000", "3000", "4000"}, {"10000", "20000", "30000", "40000"}};
        try {
    ...
    class IntAndSum {
        static int doIntAndSum(String[][] strArr) throws MyArraySizeException, MyArrayDataException {
            ...
            if (4 != strArr.length) throw new MyArraySizeException("Size of line not 4");
            for (int i = 0; i < strArr.length; i++) {
                if (4 != strArr[i].length) throw new MyArraySizeException("Size of column not 4");
